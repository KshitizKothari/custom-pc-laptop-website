...
<body>
    <form action="cpu_back.php" method="POST" enctype="multipart/form-data">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <h3 class="mbr-section-title display-4">MAKE YOUR DREAM CPU</h3>
...
<section class="mbr-section mbr-section-small" id="pricing-table1-c" data-rv-view="44" style="background-color: rgb(255, 248, 224); padding-top: 4.5rem; padding-bottom: 4.5rem;">
    ...
    <div class="container">
		...
		$r=mysqli_query($con,"select * from ram limit 4");	
		...
		{ ?>
		  <div class="col-xs-12 col-sm-6 col-md-3">
                <div class="card text-xs-center">
					...
					<strong>
					Select <?php echo $row[1]; ?>:<input type='radio' name='ram' value='<?php echo $row[2]; ?>'></a></div>
					</strong>
				</div>
            </div>
...
<section class="mbr-section mbr-section-small" id="pricing-table1-c" data-rv-view="44" style="background-color: rgb(255, 248, 224); padding-top: 4.5rem; padding-bottom: 4.5rem;">
    ...
    <div class="container">
		...
		$r=mysqli_query($con,"select * from graphic_card limit 4");	
		while($row=mysqli_fetch_array($r))
		{ ?>
		  <div class="col-xs-12 col-sm-6 col-md-3">
                <div class="card text-xs-center">
                    ...
                    <div class="card-block">
					<strong>
					Select <?php echo $row[1]; ?>:<input type='radio' name='gc' value='<?php echo $row[2]; ?>'></a></div>
					</strong>
				</div>
            </div>
...
<section class="mbr-section mbr-section-small" id="pricing-table1-c" data-rv-view="44" style="background-color: rgb(255, 248, 224); padding-top: 4.5rem; padding-bottom: 4.5rem;">
    ...
    <div class="container">
		...
		$r=mysqli_query($con,"select * from processor limit 4");	
		while($row=mysqli_fetch_array($r))
		{ ?>
		  <div class="col-xs-12 col-sm-6 col-md-3">
                <div class="card text-xs-center">
                    ...
                    <div class="card-block">
					<strong>
					Select <?php echo $row[1]; ?>:<input type='radio' name='pro' value='<?php echo $row[2]; ?>'></a></div>
					</strong>
				</div>
            </div>
...
<section class="mbr-section mbr-section-small" id="pricing-table1-c" data-rv-view="44" style="background-color: rgb(255, 248, 224); padding-top: 4.5rem; padding-bottom: 4.5rem;">
    ...
    <div class="container">
		...
		$r=mysqli_query($con,"select * from ssd limit 4");	
		while($row=mysqli_fetch_array($r))
		{ ?>
		  <div class="col-xs-12 col-sm-6 col-md-3">
                <div class="card text-xs-center">
                    ...
                    <div class="card-block">
					<strong>
					Select <?php echo $row[1]; ?>:<input type='radio' name='ssd' value='<?php echo $row[2]; ?>'></a></div>
					</strong>
				</div>
            </div>
...
<section class="mbr-section mbr-section-small" id="pricing-table1-c" data-rv-view="44" style="background-color: rgb(255, 248, 224); padding-top: 4.5rem; padding-bottom: 4.5rem;">
    ...
    <div class="container">
		...
		$r=mysqli_query($con,"select * from hard_disk limit 4");	
		while($row=mysqli_fetch_array($r))
		{ ?>
		  <div class="col-xs-12 col-sm-6 col-md-3">
                <div class="card text-xs-center">
                    ...
                    <div class="card-block">
					<strong>
					Select <?php echo $row[1]; ?>:<input type='radio' name='hdd' value='<?php echo $row[2]; ?>'></a>
					</strong>
					</div>
                </div>
            </div>
